...
class GuruMataPelajaranPolicy
{
    ...
    {
        return $user->can('view_any_guru::mata::pelajaran');
    }
    ...
    {
        return $user->can('view_guru::mata::pelajaran');
    }
    ...
    {
        return $user->can('create_guru::mata::pelajaran');
    }
    ...
    {
        return $user->can('update_guru::mata::pelajaran');
    }
    ...
    {
        return $user->can('delete_guru::mata::pelajaran');
    }
    ...
    {
        return $user->can('delete_any_guru::mata::pelajaran');
    }
